        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(memail)&&!TextUtils.isEmpty(mpass)&&!TextUtils.isEmpty(marea)&&!TextUtils.isEmpty(maddress)&&!TextUtils.isEmpty(mname)&&!TextUtils.isEmpty(mphone)){
                    mprogressdialogue = new ProgressDialog(Main2Activity.this);
                                ...
                                if (task.isSuccessful()){
                                   firebaseFirestore.collection("Worker").document("my registration").set(note).addOnSuccessListener(new OnSuccessListener<Void>() {
                                       ...
                                       public void onSuccess(Void aVoid) {
                                           Toast.makeText(Main2Activity.this,"added successfully successfully",Toast.LENGTH_SHORT).show();
                                       }
                                   })
                                    ...
                                    Toast.makeText(Main2Activity.this,"sign up successfully",Toast.LENGTH_SHORT).show();
                                    sendTomain();
                                }else {
                    ...
                    Toast.makeText(Main2Activity.this,"confirmed password and password don't match",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
